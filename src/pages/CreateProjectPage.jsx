...
// ─── Componente de campo de tag ────────────────────────────────────────────────
/**
 * TagInput — Input de texto + lista de tags interactivos.
 * El usuario puede escribir tags separados por coma o presionar Enter.
 */
...
// ─── CreateProjectPage ─────────────────────────────────────────────────────────
/**
 * CreateProjectPage — Página dedicada para publicar un nuevo proyecto.
 * Protegida: requiere sesión activa y perfil completo en `perfiles`.
 */
const CreateProjectPage = () => {
    ...
    // ─── Protección de ruta: verificar sesión y perfil ───────────────────────
    useEffect(() => {
        const verificarAcceso = async () => {
            ...
            setAutorNombre(perfil.nombre_completo ?? '');
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        Comparte tu iniciativa con la comunidad del tecnológico. Todos los campos marcados con{' '}
                    ...
                    >
                        <Campo label="Descripción" required error={errores.descripcion}>
                            <textarea
                                ...
                                onChange={handleChange}
                                placeholder="Describe el contexto del problema, la solución propuesta, el estado actual del desarrollo, tus objetivos y cualquier detalle relevante..."
                                rows={8}
